    ...
    class Program
    {
        ...
        //internal void Vagina(EventArgs Tits)
        {
            ...
            if (enemy_poof.Count > 0 && enemy_poof.Any())
            {
                ...
                if (mindist < 1200/*blink.CastRange()*/) { blink.UseAbility(ins.Position, true); Q.UseAbility(ins.Position, true); foreach (var a in enemy_poof) { W.UseAbility(ins.Position, true); } }//me.Attack(a); Utils.Sleep(me.SecondsPerAttack * 1000, "attack"); 
            }
        }
        }}
